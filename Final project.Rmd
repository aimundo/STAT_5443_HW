...
The next model was developed to detect if two user profiles belong to the same user.The authors measured the distance between two strings to identify similarly named accounts.
